...
export type LikeCommandOptions = BatchInteractCommandOptions;

/** Collect command options */
export type CollectCommandOptions = BatchInteractCommandOptions;

/** Follow command options */
export type FollowCommandOptions = BatchInteractCommandOptions;

/** Comment command options (single URL, no batch) */
export type CommentCommandOptions = BaseCommandOptions;
...
export interface ScrapeUserCommandOptions extends BaseCommandOptions {
  /** Include recent videos in result (--notes flag) */
  notes?: boolean;
  /** Max videos to include (--max-notes <number>) */
  maxNotes?: string;
}
...
export interface SearchCommandOptions extends BaseCommandOptions {
  ...
  /** Sort type (--sort <type>) */
  sort?: string;
  /** Video type filter (--note-type <type>) */
  noteType?: string;
...
export interface PublishCommandOptions extends BaseCommandOptions {
  /** Video title (--title <title>, required) */
  title: string;
  /** Video content (--content <content>, required) */
  content: string;
